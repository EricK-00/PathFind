...
public class MapBoard : MonoBehaviour
{
    ...
    private const string NAME__GO__OBSTACLE_MAP = "ObstacleMap";
    ...
    private void Awake()
    {
        ...
        // 맵에 지물을 초기화하여 배치한다.
        obstacleMap = gameObject.FindChildComponent<ObstacleMap>(NAME__GO__OBSTACLE_MAP);
